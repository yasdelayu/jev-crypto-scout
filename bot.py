...
<b>ставка %</b> — реальная ставка фандинга, ТО ЖЕ число, что на Bybit (напр. +0.01%)
<b>z</b> — это ДРУГОЕ: насколько ставка аномальна против своей истории (z=-9 не значит -9%!)
